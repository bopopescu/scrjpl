...
class Info :
    ...
    def __afficherInfos(self,simu,daarrt2d) :
        ...
        simu.blit(self.myfont.render(self.cap_string+str(daarrt2d.robotCap%360),1,(0,0,0)),(self.offsetX,self.offsetY+self.sizeWorld[1]/2 +5))
    ...
    def __afficherName(self,simu,daarrt2d):
        simu.blit(self.author_display, (self.offsetX+windowWidth-190, self.offsetY+self.sizeWorld[1]-70))
        simu.blit(self.date_display, (self.offsetX+windowWidth-190, self.offsetY+self.sizeWorld[1]-58))
        simu.blit(self.team_display, (self.offsetX+windowWidth-190, self.offsetY+self.sizeWorld[1]-48))
