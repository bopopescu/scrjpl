...
#define lmbrkpin     9//4  //  D4 - left  motor brake        control    pin    HIGH = Brake 
#define lmdirpin     10//2  //  D2 - left  motor direction    control    pin    HIGH = Forward   Low = Reverse
#define lmpwmpin     11//3  //  D3 - left  motor pulse width  modulation pin    0 - 255          Speed and Brake 
#define lmcurpin     7//6  //  A6 - left  motor current      monitor    pin    0 - 1023         -20A to +20A   

#define rmbrkpin    4// 9  //  D9 - right motor brake        control    pin    HIGH = Brake 
#define rmdirpin    2//10  // D10 - right motor direction    control    pin    HIGH = Forward   Low = Reverse
#define rmpwmpin    3//11  // D11 - right motor pulse width  modulation pin    0 - 255          Speed and Brake 
#define rmcurpin     6//7  //  A7 - right motor current      monitor    pin    0 - 1023         -20A to +20A   
